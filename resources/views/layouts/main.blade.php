...
<html lang="en">
  <head>
    ...
    <!-- CSS asset untuk Datatabel -->
    <link rel="stylesheet" href="https://cdn.datatables.net/2.0.7/css/dataTables.dataTables.css">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css">
    <title>.HAIRHEAVEN - @yield('title'):.</title>
  </head>
  <body>
            ...
            <div class="col-md-2  vh-100">
                ...
                <div class="col-3">
                  <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    ...
                    <a class="nav-link {{ ($key == "produk") ? "active":""}}" id="v-pills-profile-tab"  href="/produk" >Produk</a>
                    <a class="nav-link" id="v-pills-messages-tab"  href="#" >Messages</a>
                    <a class="nav-link" id="v-pills-settings-tab"  href="#v" >Settings</a>
                  </div>
                </div>
              </div></div>
